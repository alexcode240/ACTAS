...
class WordController
{
    ...
    public function ctrGenerateWord()
    {
        ...
        $hecho1 = "1.	Los Servidores Públicos con adscripción al Órgano Interno de Control, a la Subdirección de Patrimonio Municipal, a la Segunda Sindicatura y a la (al) " . $respuesta["FCAREA"] . ", se constituyen el día, hora y lugar referido en el párrafo primero de la presente Acta Circunstanciada, esto en atención al oficio con número de folio " . $respuesta["FCOFICIO"] . ", de fecha " . $fechaOficio["dia"] . " de " . $fechaOficio["mes"] . " de " . $fechaOficio["anio"] . ", suscrito por el C.P. Ricardo Contreras Velázquez, Contralor Interno Municipal, el cual fue notificado el día " . $fechaNotificacion["dia"] . " de " . $fechaNotificacion["mes"] . " de " . $fechaNotificacion["anio"] . ", al (a la) C. " . $respuesta["FCENLACE"] . " en su carácter de Enlace Administrativo de la (del) " . $respuesta["FCAREA"] . " de Tlalnepantla de Baz, Estado de México, administración 2022-2024, a fin de comunicarle que el PRIMER LEVANTAMIENTO FÍSICO DE BIENES MUEBLES DE 2022, sería del " . $fechaLevantamiento["dia"] . " de " . $fechaLevantamiento["mes"] . " al " . $fechaFinLevantamiento["dia"] . " de " . $fechaFinLevantamiento["mes"] . " de " . $fechaFinLevantamiento["anio"] . ", a partir de las " . $fechaLevantamiento["hora"] . " horas, para verificar la existencia física de los bienes muebles en uso y custodia de la (del) ". $respuesta["FCAREA"] .", con base en el LISTADO DE BIENES MUEBLES DEL PRIMER LEVANTAMIENTO FÍSICO 2022, de la (del) " . $respuesta["FCAREA"] . ", expedido por la Subdirección de Patrimonio Municipal, dependiente de la Secretaría del Ayuntamiento.";
